...
# AUTHOR: Matthias Monnier (matthias.monnier@gmail.com), Théo Nhyvon, Simone Mora (simonem@ntnu.no)
# DATE: 16/12/2015
...
void setup(void)
{
        ...
        //LED = new RGB_LED(0, 1, 2); //config white and red tiles
        LED = new RGB_LED(2, 3, 4); //config shield tile
